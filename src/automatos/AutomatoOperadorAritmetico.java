		...
		while (!buffer.fimCodigo()) {
			...
			case 0:
				...
				if (c == '+') {
					 ...
					 * else if(c=='/'){ consumirCaractere(); if
					 * (buffer.fimCodigo() == true) { return
					 * getToken(TipoToken.OPERADOR_ARITIMETICO_DIVISAO); } else
					 * if(buffer.getTamanhoCodigo() == 1) { return
					 * getToken(TipoToken.OPERADOR_ARITIMETICO_DIVISAO); }else{
					 * 
			...
			case 1:
				...
				if (c == '+') {
					...
					return new Token(TipoToken.OPERADOR_ARITIMETICO_ADICAO, "+", buffer.getLinhaAtual(),
